...
import org.smartregister.chw.core.activity.CoreGeMemberProfileActivity;
...
public class CoreGeRegisterFragment extends BaseGeRegisterFragment {
    private View view;
    ...
    protected void initializePresenter() {
        ...
        presenter = new BaseGeRegisterFragmentPresenter(this, new BaseGeRegisterFragmentModel(), null);
    }
    ...
    protected void openProfile(String baseEntityId) {
        CoreGeMemberProfileActivity.startMe(getActivity(), baseEntityId);
    }
